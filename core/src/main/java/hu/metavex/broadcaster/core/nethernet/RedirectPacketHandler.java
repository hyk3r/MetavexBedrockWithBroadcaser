...
public class RedirectPacketHandler implements BedrockPacketHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RedirectPacketHandler.class);
    ...
    public RedirectPacketHandler(BedrockServerSession session, SessionInfo sessionInfo, SessionManager sessionManager) {
    ...
    public PacketSignal handlePacket(BedrockPacket packet) {
        // BedrockPacketHandler.super.handlePacket(packet); // Interface default might not exist or verify
    ...
    public void sendStartGame() {
        ...
        startGamePacket.setLevelName("MetavexMCBroadcaster");
        ...
        if (identityData != null) {
            LOGGER.info("Transferred bedrock client {} ({}) to target server.", identityData.displayName, identityData.xuid);
        }
    }
}
